...
keys = [
    ...
    EzKey("A-<XF86KbdBrightnessDown>", lazy.spawn("kbdlight off")),
    EzKey("A-<XF86MonBrightnessUp>", lazy.spawn("light -S 100")),
    EzKey("A-<XF86MonBrightnessDown>", lazy.spawn("light -S 0")),
    EzKey("M-C-h", lazy.spawn("nautilus")),
